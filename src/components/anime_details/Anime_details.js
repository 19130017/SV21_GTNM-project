                      ...
                      <div className="anime_details_widget">
                        <div className="row">
                          ...
                          <div className="col-lg-6 col-md-6">
                            <ul>
                              <li>
                                <span>Scores:</span> {this.props.score}
                              </li>
                              <li>
                                <span>Rating:</span> {this.props.rate}
                              </li>
                              <li>
                              ...
                              <li>
                                <span>Views:</span> {this.props.view}
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div className="anime_details_review">
                    ...
                    <div className="anime_review_item">
                      ...
                      <div className="anime_review_item_text">
                        ...
                        <p>
                          whachikan Just noticed that someone categorized this
