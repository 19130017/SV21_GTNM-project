              ...
              <div className="col-lg-6">
                <div className="row">
                  <div className="col-lg-12">
                    ...
                    >
                      <div className="blog_item_text">
                        ...
                        <h4>
                          <a href="/blog_details">
                            Yuri Kuma Arashi Viverra Tortor Pharetra
                          </a>
                        </h4>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6">
                    <div
                      className="blog_item small_item set-bg"
                  ...
                  <div className="col-lg-12">
                    ...
                    >
                      <div className="blog_item_text">
                        ...
                        <h4>
                          <a href="#">
                            Housekishou Richard shi no Nazo Kantei Season 08 -
                            20
                          </a>
                        </h4>
                      </div>
